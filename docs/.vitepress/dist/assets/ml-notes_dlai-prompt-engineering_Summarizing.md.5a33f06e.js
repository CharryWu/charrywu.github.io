import{_ as s,o as a,c as n,O as e}from"./chunks/framework.659f2aa6.js";const h=JSON.parse('{"title":"Summarizing using ChatGPT","description":"","frontmatter":{},"headers":[],"relativePath":"ml-notes/dlai-prompt-engineering/Summarizing.md","filePath":"ml-notes/dlai-prompt-engineering/Summarizing.md"}'),l={name:"ml-notes/dlai-prompt-engineering/Summarizing.md"},p=e(`<h1 id="summarizing-using-chatgpt" tabindex="-1">Summarizing using ChatGPT <a class="header-anchor" href="#summarizing-using-chatgpt" aria-label="Permalink to &quot;Summarizing using ChatGPT&quot;">​</a></h1><h2 id="regular-summaries" tabindex="-1">Regular summaries <a class="header-anchor" href="#regular-summaries" aria-label="Permalink to &quot;Regular summaries&quot;">​</a></h2><p>Regular summaries include topics that are not related to the topic of focus.</p><div class="language-py"><button title="Copy Code" class="copy"></button><span class="lang">py</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">prod_review </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&quot;&quot;&quot;</span></span>
